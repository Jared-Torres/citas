...
if (!empty($_POST['user']) && !empty($_POST['correo']) && !empty($_POST['name']) && !empty($_POST['paterno']) && !empty($_POST['password'])) {

  $sql = "INSERT INTO cliente (correo, password, user, nombre, paterno) VALUES (:correo, :password, :user, :name, :paterno)";
...
<body>
  <div class="justify-content-center centrar p-3">
    ...
    <form class="row g-3" action="signup.php" method="post">
      ...
      <div class="col-md-5 mb-4">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" id="validationDefaultUsername" placeholder="Usuario..." name="user" aria-describedby="inputGroupPrepend2" required>
        </div>
      </div>
      <div class="col-md-7">
        ...
        <div class="input-group">
          ...
          <input type="email" class="form-control bg-light-x border-i" id="validationDefault03" placeholder="Ingresa tu Email..." id="exampleInputEmail1" aria-describedby="emailHelp" name="correo" required>
        </div>
      </div>
      ...
      <div class="col-md-4">
        ...
        <input type="password" class="form-control bg-light-x" id="validationDefault06" placeholder="Ingresa tu contraseña" id="exampleInputPassword1" name="password2" required>
    ...
    <div class="text-center px-ñg-5 pt-lg-3 pb-lg-4 p-4 w-100 mt-auto">
      ...
      <a href=" index.php" class="cuenta1 text-decoration-none" style="font-weight: bold;">Inicie sesion</a>
    </div>
  </div>
