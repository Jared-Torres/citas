<div class="p-1 fondo-footer">
    <footer class="py-3 my-4">
      <ul class="nav justify-content-center border-bottom pb-3 mb-3">
        ...
        <li class="nav-item"><a href="acerca_de.php" class="nav-link px-2 text-white">Acerca de</a></li>
        <li class="nav-item"><a href="principal.php" class="nav-link px-2 text-white">Cuenta</a></li>
      </ul>
